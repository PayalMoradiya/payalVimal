    ...
    <div class="container m-auto mt-3 row">
        <div class="col-8">
            ...
            if(isset($_GET['search'])) {
                ...
                $query = "SELECT * FROM blogs WHERE title LIKE '%$keywords%' ORDER BY id DESC LIMIT 0,4";
            } else {
                //get five blog per page with latest post on top
                $query = "SELECT * FROM blogs WHERE category_id = '".$category_id."' ORDER BY id DESC LIMIT 0,4";
            }
