      ...
      <div class="row">
        ...
        <div class="col-md-5">
          <div class="form-group">
					  ...
					  <div class="form-group">
						 <label class="control-label col-sm-2 my-2" for="subject">Subject:</label>
						 <div class="col-sm-10">
					  ...
					  <div class="form-group">
						 <label class="control-label col-sm-2 my-2" for="comment">Message:</label>
						 <div class="col-sm-10">
							<textarea class="form-control" rows="5" id="comment" name="comment" placeholder="Type message" required></textarea>
						 </div>
					  </div>
					  <div class="form-group">
